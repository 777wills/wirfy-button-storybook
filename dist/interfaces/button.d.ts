...
declare type colorButton = 'is-black' | 'is-danger' | 'is-dark' | 'is-ghost' | 'is-info' | 'is-link' | 'is-primary' | 'is-success' | 'is-text' | 'is-warning' | 'is-white';
declare type sizeButton = 'is-large' | 'is-medium' | 'is-normal' | 'is-small';
declare type stateButton = 'is-active' | 'is-focused' | 'is-hovered';
